"""
Django settings for opd_use_of_force project.
...
SECRET_KEY = '38r&dd7po)z51nv$^xz5)7^7!&9f&#3mai4r)1)5=0@i^*5qng'
...
ROOT_URLCONF = 'opd_use_of_force.urls'

WSGI_APPLICATION = 'opd_use_of_force.wsgi.application'
